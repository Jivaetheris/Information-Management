...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($username) || empty($password) || empty($firstName) || empty($lastName) || empty($contact)) {
        ...
        $message = "Contact number must be 11 digits PH ex: 09123456798";
    } else {
        ...
        if ($checkUsername->num_rows > 0) {
            ...
            $stmt->bind_param("sssss", $username, $hashedPassword, $firstName, $lastName, $contact);
...
<body>
    <div id="container">
        ...
        <form action="" method="POST">
            ...
            <input type="text" class="contact" name="contact" placeholder="Contact Number" required><br><br>
